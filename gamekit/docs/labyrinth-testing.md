...
Run from `gamekit/`. CI profile uses the same source/features with faster unoptimized
...
cargo run -p labyrinth --example labyrinth_review --profile ci -- \
  target/labyrinth-1920-auto.png 1920 1080 auto combat
```
...
Use independent profiles as described in [the game README](../games/labyrinth/README.md).
