...
See [architecture](../../docs/architecture.md) and the [Labyrinth](../../games/labyrinth/README.md)
or [deckbuilder](../../games/deckbuilder/README.md) instructions for their distinct UX.
...
coverage and interactive acceptance live in each game; see [evidence rules](../../docs/testing.md).
