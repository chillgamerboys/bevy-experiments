...
implemented in [the Rust CI module](../../../devtools/src/ci/mod.rs); the owner accepted the trial
results and authorized their merge on September 10, 2026.
[Testing guidance](../../../docs/testing.md#ci-selection) owns current commands. The rationale
and acceptance criteria below guide the bounded trials
before the [repository-wide Rust tooling migration](../history/gameskills-rust-cli.md), which
