...
fn capture(
    ...
    let click = match (capture.route.as_str(), capture.frame) {
        ...
        ("editor-rank4" | "editor-compare" | "editor-detail", 6) => Some("Category Equipment"),
        ("editor-rank4", 9) => Some("Weapon dagger"),
        (route, 2) if route.starts_with("editor") => Some("Select Heroes Rank 1"),
        (route, 4) if route.starts_with("editor") => Some("Edit Actor 1"),
        ("editor-compare", 9) => Some("Weapon greatsword"),
        ("editor-detail", 9) => Some("Weapon dagger"),
        ("editor-abilities", 7) => Some("Category Abilities"),
        ("editor-abilities", 10) => Some("Ability duelist_dagger_power"),
