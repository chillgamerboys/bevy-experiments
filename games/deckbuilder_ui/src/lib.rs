...
// The deckbuilder explicitly chooses its neutral skin and card geometry. These
...
fn panel(name: impl Into<String>) -> impl Bundle {
    (
        ...
        UiSpacing {
            ...
            row_gap: Some(UiSpace::Units(1.0)),
            ..default()
        },
    )
}
...
fn card(name: impl Into<String>) -> impl Bundle {
    (
        ...
        UiSpacing {
            padding: Some(UiInsets::all(UiSpace::Pixels(14.0))),
            row_gap: Some(UiSpace::Pixels(10.0)),
            ..default()
        },
    )
}
...
fn button(name: impl Into<String>) -> impl Bundle {
    (
        ...
        UiSpacing {
            padding: Some(UiInsets::axes(UiSpace::Pixels(18.0), UiSpace::Pixels(10.0))),
            ..default()
        },
    )
}
...
fn text_field(
    ...
    (
        ...
        UiSpacing {
            padding: Some(UiInsets::axes(UiSpace::Pixels(14.0), UiSpace::Pixels(10.0))),
            ..default()
        },
    )
}
