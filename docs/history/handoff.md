...
[Labyrinth verification](../../games/labyrinth/docs/testing.md). The original
...
- [Labyrinth ownership map](../../games/labyrinth/docs/architecture.md)
- [Verification commands and evidence](../../games/labyrinth/docs/testing.md)
- [Footprints, death saves and corpse policy](../../games/labyrinth/docs/decisions/footprints-and-death.md)
...
Location: [SessionPasswordVerifier::verify](../../gamekit/session/src/password.rs),
